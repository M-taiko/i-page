...
@section('content')
    ...
    <div class="back-button">
        <a href="{{ route('tenant.channels.index') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="page-header mb-3">
        <div class="page-header-info">
            ...
            <p>Set up a new channel for your organization</p>
        </div>
    </div>
    ...
    <form action="{{ route('tenant.channels.store') }}" method="POST">
        @csrf
        ...
        <div style="max-width: 700px;">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    @if($brands->isEmpty())
                        <div class="text-danger small mt-2"><i class="bi bi-exclamation-circle"></i> No active brands yet — create a brand in Settings first.</div>
                    @endif
            ...
            <div class="form-section">
                ...
                <div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="public" value="public" {{ old('type', 'public') === 'public' ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="private" value="private" {{ old('type') === 'private' ? 'checked' : '' }}>
            ...
            <div class="form-footer">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="bi bi-check-circle"></i> Create Channel
                </button>
                <a href="{{ route('tenant.channels.index') }}" class="btn btn-outline-secondary btn-lg">
